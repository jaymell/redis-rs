...
test:
	...
	@echo "===================================================================="
	@REDISRS_SERVER_TYPE=unix cargo test -p redis --all-features -- --skip test_cluster --skip test_async_cluster

	@echo "===================================================================="
	@echo "Testing async-std"
	@echo "===================================================================="
	@REDISRS_SERVER_TYPE=tcp+tls cargo test -p redis --features=async-std-tls-comp,cluster-async -- --nocapture --test-threads=1
